...
<body class="animsition">
	...
	<!-- Header -->
	<header class="header-v3"> <!-- Header desktop -->
	<div class="container-menu-desktop trans-03">
		<div class="wrap-menu-desktop">
			<nav class="limiter-menu-desktop p-l-45"> <!-- Logo desktop -->
			<a href="index.html" class="logo"> <img
				src="images/icons/logo-02.png" alt="IMG-LOGO">
			</a> <!-- Menu desktop -->
			<div class="menu-desktop">
				<ul class="main-menu">
					<li><a href="index.html">Home</a></li>
					<li class="active-menu label1" data-label1="hot"><a
						href="product.html">Cosmetics</a>
						<ul class="sub-menu">
							<li><a href="product.html">All Products</a></li>
							<li><a href="product.html">Skin</a></li>
							<li><a href="product.html">Lotion</a></li>
							<li><a href="product.html">All in One</a></li>
							<li><a href="product.html">Cleaning</a></li>
							<li><a href="product.html">Make Up</a></li>
						</ul></li>
					<li class="active-menu"><a href="product.html">Hair</a>
						<ul class="sub-menu">
							<li><a href="product.html">Hair1</a></li>
							<li><a href="product.html">Hair2</a></li>
							<li><a href="product.html">Hair3</a></li>
							<li><a href="product.html">Hair4</a></li>
							<li><a href="product.html">Hair5</a></li>
							<li><a href="product.html">Hair6</a></li>
						</ul></li>
	...
	<div class="menu-mobile">
		<ul class="main-menu-m">
			...
			<li><a href="product.html" class="label1 rs1" data-label1="hot">Cosmetics</a></li>
	...
	<div class="wrap-slick1 rs2-slick1">
		<div class="slick1">
			<div class="item-slick1 bg-overlay1"
				style="background-image: url(images/slide-06.jpg);"
				data-thumb="images/thumb-02.jpg" data-caption="Men's Cosmetics">
				<div class="container h-full">
					<div class="flex-col-c-m h-full p-t-100 p-b-60 respon5">
						<div class="layer-slick1 animated visible-false"
							data-appear="rollIn" data-delay="0">
							<span class="ltext-202 txt-center cl0 respon2"> Man's
								Cosmetics Collection 2019 </span>
						</div>
			...
			<div class="item-slick1 bg-overlay1"
				style="background-image: url(images/slide-05.jpg);"
				data-thumb="images/thumb-01.jpg" data-caption="Men's Hair">
				<div class="container h-full">
					<div class="flex-col-c-m h-full p-t-100 p-b-60 respon5">
						<div class="layer-slick1 animated visible-false"
							data-appear="fadeInDown" data-delay="0">
							<span class="ltext-202 txt-center cl0 respon2"> Men's Hair
								Products Collection 2019 </span>
						</div>
						...
						<img src="images/banner-04.jpg" alt="IMG-BANNER"> <a
							...
							<div class="block1-txt-child1 flex-col-l">
								<span class="block1-name ltext-102 trans-04 p-b-8">
									Cosmetics </span> <span class="block1-info stext-102 trans-04">
									New Trend </span>
							</div>
				...
				<div class="col-md-6 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<img src="images/banner-05.jpg" alt="IMG-BANNER"> <a
							...
							class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
							<div class="block1-txt-child1 flex-col-l">
								<span class="block1-name ltext-102 trans-04 p-b-8"> Hair
								</span> <span class="block1-info stext-102 trans-04"> New Trend
								</span>
							</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-6 col-lg-3 p-b-50">
				...
				<ul>
					<li class="p-b-10"><a href="product.html"
						class="stext-107 cl7 hov-cl1 trans-04"> Cosmetics </a></li>

					<li class="p-b-10"><a href="product.html"
						class="stext-107 cl7 hov-cl1 trans-04"> Hair </a></li>
			...
			<div class="col-sm-6 col-lg-3 p-b-50">
				...
				<ul>
					<li class="p-b-10"><a href="prepare_page.html"
						class="stext-107 cl7 hov-cl1 trans-04"> Order inquiry </a></li>

					<li class="p-b-10"><a href="prepare_page.html"
						class="stext-107 cl7 hov-cl1 trans-04"> Exchange & Returns </a></li>

					<li class="p-b-10"><a href="prepare_page.html"
						class="stext-107 cl7 hov-cl1 trans-04"> Delivery Tracking </a></li>
			...
			<div class="col-sm-6 col-lg-3 p-b-50">
				<h4 class="stext-301 cl0 p-b-30">Location</h4>

				<p class="stext-107 cl7 size-201">Teheranro 212, Gangnam-gu,
					Seoul 02-3429-5114</p>
